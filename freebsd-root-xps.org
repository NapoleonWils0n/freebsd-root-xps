...
#+PROPERTY: header-args :mkdirp yes :tangle-mode o644
* tangle dotfiles
** tangle document
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/boot/loader.conf"
<<loader.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/devfs.rules"
<<devfs.rules>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/dhclient-enter-hooks"
<<dhclient-enter-hooks>>
#+END_SRC
...
#+NAME: fstab-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/fstab"
<<fstab>>
#+END_SRC
...
#+NAME: jail-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/jail.conf"
<<jail>>
#+END_SRC
...
#+NAME: login-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/login.conf"
<<login>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/pf.conf"
<<pf.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/rc.conf"
<<rc.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/resolv.conf"
<<resolv.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/sysctl.conf"
<<sysctl.conf>>
#+END_SRC
...
#+NAME: ttys-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/ttys"
<<ttys>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/unbound/conf.d/custom.conf"
<<custom.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/unbound/forward.conf"
<<forward.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/etc/unbound/unbound_outgoing_interface"
<<unbound_outgoing_interface>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/rc.d/laggpf" :tangle-mode (identity #o755)
<<laggpf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "usr/local/etc/rc.d/laggpf" :tangle-mode (identity #o755)
<<laggpf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/rc.d/musicpd" :tangle-mode (identity #o755)
<<musicpd>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "usr/local/etc/rc.d/musicpd" :tangle-mode (identity #o755)
<<musicpd>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/usbhidaction.conf"
<<usbhidaction.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/devd/devd.conf"
<<devd.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/dnscrypt-proxy/dnscrypt-proxy.toml"
<<dnscrypt-proxy.toml>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/pkg/repos/poudriere.conf"
<<pkg/repos/poudriere.conf>>
#+END_SRC
...
#+NAME: doas-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/doas.conf"
<<doas>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/poudriere.conf"
<<poudriere.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/poudriere.d/make.conf"
<<make.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/doas::/usr/local/etc/poudriere.d/port-list"
<<port-list>>
#+END_SRC
