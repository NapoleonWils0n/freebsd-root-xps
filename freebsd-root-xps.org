...
kld_list="i915kms nvidia-modeset nvidia-drm nvidia_gsp_tu10x_fw linux linux64 ext2fs mac_priority fusefs vmm nmdm"
...
vfs.usermount=1
vfs.fusefs.tunable.user_allow_other=1
...
#+BEGIN_SRC conf :tangle "/doas::/etc/unbound/conf.d/custom.conf"
<<custom.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "etc/unbound/conf.d/custom.conf"
<<custom.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "/doas::/etc/unbound/forward.conf"
<<forward.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "etc/unbound/forward.conf"
<<forward.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "/doas::/etc/unbound/unbound_outgoing_interface"
<<unbound_outgoing_interface>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "etc/unbound/unbound_outgoing_interface"
<<unbound_outgoing_interface>>
#+END_SRC
...
#+NAME: pkg.conf-root-dir
#+BEGIN_SRC conf :tangle "/doas::/usr/local/etc/pkg.conf"
<<pkg.conf>>
#+END_SRC
  
+ current dir

#+NAME: pkg.conf-current-dir
#+BEGIN_SRC conf :tangle "usr/local/etc/pkg.conf"
<<pkg.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "/doas::/usr/local/etc/poudriere.d/make.conf"
<<make.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "usr/local/etc/poudriere.d/make.conf"
<<make.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "/doas::/usr/local/etc/poudriere.d/port-list"
<<port-list>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle "usr/local/etc/poudriere.d/port-list"
<<port-list>>
#+END_SRC
